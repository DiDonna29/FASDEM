...
%>
	...
	<tiles:put name="titulopagina" content="Inicio / Pagos / Edición de PreOrdenes"
		direct="true" />
...
%>
	 ...
	 <% if (List!=null && List.size()!=0){%>				
				...
				<tr class="tituloCabecera">
                    <td align="center">Nro de Pre Orden</td>
					<td align="center">Estatus</td>	
				    <td align="center">Detalle</td>	
				    <td align="center">Reporte</td>
				    <td align="center">Agregar Fac</td>
				    <td align="center">Eliminar Fac</td>	
      ...
      %>  		
				...
				<tr class="item" bgcolor="white" >
					...
					<%if (list.getEstatus().getId()== Constantes.StatusEnAdministracion ){ %>
						<td class="grayplink" align="center"> 
		                   <img onclick="ir2(6,'<%=list.getCod_completo()%>');" style="cursor:hand" src="<%=request.getContextPath()%>/images/page_add.png" width="14" height="13" title="Agregar Facturas">
		                </td>	
		                
		                
		                <td class="grayplink" align="center"> 
		                   <img onclick="ir2(5,'<%=list.getCod_completo()%>');" style="cursor:hand" src="<%=request.getContextPath()%>/images/page_delete.png" width="14" height="13" title="Eliminar Facturas">
		                </td>
				...
				<%if (primera!=null){ %>
					 ...
					 <tr>
						<td align="center" class="grayp" style="padding-left: 20px; padding-bottom: 5px;">
							<div class="grayp"></div>
							<strong>No existen PreOrdenes pendientes por autorización</strong>
							<div class="grayp"></div>
						</td>
					</tr>
