 ...
 * 
 */
public class retencionOrdenPago extends GenericAction {


    static protected Logger log = Logger.getLogger(retencionOrdenPago.class);
           ...
           return mapping.findForward("H1");
    		...
    		if ("procesado".equals(request.getParameter("procesar"))) {
    	    	/////////////////////////////////////////////////////////
    				...
    				if (mes == null || "-1".equals(mes) || "-1".equals(tipoProveedor)) {
			...
			if(accion.equals("1")){ //// 
				...
				request.setAttribute("tipoEmpleado", ExpTipoEmpleado.BuscarLista());
		    	request.setAttribute("listaTipoProv",ExpTipoProveedor.BuscarLista());
		    	request.setAttribute("lista",ExpTipoProveedor.BuscarRetencion(Integer.parseInt(request.getParameter("mes")), Integer.parseInt(request.getParameter("idProveedor")), Integer.parseInt(request.getParameter("periodo"))));
