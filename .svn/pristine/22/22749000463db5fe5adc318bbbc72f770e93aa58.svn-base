...
%>
    ...
    <table  class="tabla" width="600" cellpadding="2" cellspacing="1" border="1">
				...
				<tr  >
					...
					<td width="30%"> -- Codigo de Pre Orden</td>
				...
				<tr >
				 ...
				 <tr >
                                        ...
                                        <td> --Usuario Creación Pre Orden</td>
                                        <td><strong><%=(preO.getUsuario()!=null?preO.getUsuario():"S/N")%></strong></td>
				...
				<tr >
					...
					<td> -- Hoja de Ruta</td>
					<td><strong><%=(preO.getHoja()==null?"S/H":preO.getHoja().getNumero()) %></strong></td>
				...
				<tr >
					...
					<td> -- Hoja de Ruta</td>
					<td><strong><%=(preO.getHoja()==null?"S/H":preO.getHoja().getStatus().getDescripcion()) %></strong></td>
	...
	<%if(preO.getTipo_preorden()!= Constantes.TipoPreOrdenReembolsos){ %>
		...
		<%}%>	
				...
				<div style="border-bottom-color: #EEEEEE; border-bottom-width: thin; border-bottom-style: solid">&nbsp;</div>
 				...
 				<div class="sp5"></div>
				<div align="right">
				<input class="boton" value="Regresar" type="button"  onclick="window.history.back();" />
				</div>
