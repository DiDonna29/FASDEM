...
import ve.gob.dem.fasdem.persit.administrador.PerTipoTramitePortal;
import ve.gob.dem.framework.cnx.Conexion;
import ve.gob.dem.framework.exception.PersonalNotFoundException;


public class ExpTipoTramitePortal {
	 ...
	 public static ArrayList BuscarLista() throws NamingException, SQLException, PersonalNotFoundException  {
		 Connection cnx = null;
	    	try {
	    		...
	    		PerTipoTramitePortal ps = new PerTipoTramitePortal(cnx);
