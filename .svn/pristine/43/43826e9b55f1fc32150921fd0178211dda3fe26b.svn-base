...
<%@page import="ve.gob.dem.framework.recursos.Utilidad"%>
...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Bandeja de cambio de estatus" direct="true" />
	...
	<tiles:put name="cuerpo" direct="true">
		...
		<div class="parametro titulo "><html:text styleClass="cgp" name="globalActionForm" property="codigo" /><html:submit styleClass="boton" value="Buscar" /></div>
		...
		<table class="tabla" width="500" cellpadding="1" cellspacing="1" border="0" bgcolor="yellow">
			...
			<pg:pager maxPageItems="<%=10%>" maxIndexPages="10" url="bandejaAnalizar.do" isOffset="false" export="offset,currentPageNumber=pageNumber" scope="request">
				<pg:param name="id" />
...
<script>
function submit2(arg, argAnio){
document.forms[0].action='<%=request.getContextPath()%>/security/aps/cambioEstatus.do';
