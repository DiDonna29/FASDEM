...
public class CoberturaNotDisponibleException extends Exception implements Serializable{
	 ...
	 * 
	 */
	public CoberturaNotDisponibleException() {
		super();
		error = new Errores();
	}
	 ...
	 * @param arg0
	 */
	public CoberturaNotDisponibleException(String argDescripcion) {
	 ...
	 */
	public CoberturaNotDisponibleException(String argCodigo, String argMensaje) {
	 ...
	 * @param arg0
	 */
	public CoberturaNotDisponibleException(Throwable arg0) {
	...
	* @param arg0
	*/
   public CoberturaNotDisponibleException(Errores arg0) {
