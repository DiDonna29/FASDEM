...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Estadistica de Reembolsos"
		direct="true" />
	...
	<tiles:put name="cuerpo" direct="true">
		<fmt:formatDate value="${fechaInicio}" pattern="dd/MM/yyyy" />
		 ...
		 type="button" onclick="javascript:openWinScroll2('<%=request.getContextPath()%>/security/comunes/generareporte.do?id_reporte=7&fechaInicio='+this.document.forms[0].fechaInicio.value+'&fechaFin='+document.forms[0].fechaFin.value,'EstadisticaRembolso',800,600);" /></div>
