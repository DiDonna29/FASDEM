...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<div class="parametro titulo">
	<input class="cgp" type="text" name="codigo" value="<c:out value='${codigo}'/>"/>	
	</div>		
...
function submit2(argid){
	...
	document.forms[0].action='<%=request.getContextPath()%>/security/medicinas/detalle.do';
