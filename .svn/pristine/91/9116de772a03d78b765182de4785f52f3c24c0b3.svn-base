 ...
 * 
 */
public class ConsultaEstadisticas extends Action {
     ...
     */
    static protected Logger log = Logger.getLogger(ConsultaEstadisticas.class);
...
if(request.getParameter("accion")!=null){	 
	 if(request.getParameter("accion").equals("1")){
    	 ...
    	 try {
			   ...
			   lista = ExpSiniestroBandeja.BuscarListaAtendidosyAtencion(Constantes.IdentificadorAPS, analist,fch,fch2);
		 ...
		 try {
			   ...
			   lista = ExpUsuarioEstadistica.buscarListaPorTipoFechaEstadistica(Constantes.SolicitudAtendida ,Constantes.IdentificadorAPS, fch,fch2);
