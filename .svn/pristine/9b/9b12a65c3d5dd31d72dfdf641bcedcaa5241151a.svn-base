...
<input type="hidden" name="accion"/>
	...
	<tiles:put name="titulopagina" content="Seleccione un Proveedor"
		direct="true" />
	<tiles:put name="itemsup" content="/jsp/comunes/items.jsp" />
    <tiles:put name="itemsdown" content=" " direct="true" />
	<tiles:put name="cuerpo" direct="true">
	<input type="hidden" name="idtipoGasto" value="<c:out value="${idProveedor}" />"/>
					<table>
                
				<tr class="cgp" bgcolor="white">
					<td colspan="6"></td>
					<td align="right" colspan="2"><a class="nredp" href="<%=request.getContextPath()%>/security/administradores/AgregarProveedor.do">Agregar</a></td>
