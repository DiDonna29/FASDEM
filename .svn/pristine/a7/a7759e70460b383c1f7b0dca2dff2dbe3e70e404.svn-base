...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Liquidación de Cartas Avales" direct="true" />
	<tiles:put name="itemsup" content="/jsp/comunes/items.jsp" />
	<tiles:put name="itemsdown" content="" direct="true" />
	<tiles:put name="cuerpo" direct="true">
		<input type="hidden" name="id" id="id" />
		<div class="etiqueta titulo cgp">Año</div>
		<div class="parametro titulo "><html:select name="globalActionForm" property="anio">
...
document.forms[0].action='<%=request.getContextPath()%>/security/cartaAval/liquidacion/liquidarCartaAval.do';
