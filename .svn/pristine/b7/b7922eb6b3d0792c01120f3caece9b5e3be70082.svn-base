...
%>
	...
	<tiles:put name="titulopagina" content="Inicio / Pagos / Busqueda de Pre Ordenes de Pago pendientes por Autorización"
		direct="true" />
      ...
      %>  		
				...
				<tr class="item" bgcolor="white" >
					...
					<%if(list.getEstatus().getId()==Constantes.StatusEnAdministracion){ %>
						...
						<td class="grayplink" align="center"> 
		                   <img onclick="ir2(5,'<%=list.getCod_completo()%>');" style="cursor:hand" src="<%=request.getContextPath()%>/images/ic3d_enviado.gif" width="14" height="13" title="Autorizar">
		                </td>	
