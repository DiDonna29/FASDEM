...
<div class="sp5"></div>
			...
			<!--table class="tabla" width="600" cellpadding="2" cellspacing="1" border="0">
				 <tr>
						<td align="center" colspan="7" class="grayp" style="padding-left: 20px; padding-bottom: 5px;">
							<div class="grayp"></div>
							<strong></strong>
							<div class="grayp"></div>
						</td>
      ...
      %>  
				 <tr class="item" bgcolor="white" onclick="modificaP('<%=pro.getId()%>');">
					...
					<td><%if(pro.getIsActivo()){%>Activo<%}else{%>Inactivo<%}%></td>
...
<script language="JavaScript">
	function ir(acc){
		...
		document.forms[0].action = "<%=request.getContextPath()%>/security/administradores/adminProveedores.do"
