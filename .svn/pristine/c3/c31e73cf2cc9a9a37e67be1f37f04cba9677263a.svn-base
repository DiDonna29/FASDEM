...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<input type="hidden" name="idEspecialidad" value="<c:out value="${idEspecialidad}" />"/>
			<table>
                
				<tr class="cgp" bgcolor="white">
					<td colspan="6"></td>
					<td align="right" colspan="2"><a class="nredp" href="<%=request.getContextPath()%>/security/administradores/AgregarEspecialidad.do">Agregar</a></td>
