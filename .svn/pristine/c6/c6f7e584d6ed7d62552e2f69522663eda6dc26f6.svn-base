...
<%
		...
		HojaRuta List=(HojaRuta)request.getAttribute("lista");
...
%>
	...
	<tiles:put name="titulopagina" content="Inicio / Pagos / Cambio de Estatus PreOrden Masivos"
		direct="true" />
...
%>
			...
			<div style="overflow: visible">
				...
				<div class="etiqueta titulo cgp">Codigo de Hoja Ruta</div>
				
				<div class="parametro titulo cgp">
				
					<input type="text" name="codigo2" id="codigo2" value="" size="10" maxlength="5" class="cgp"> 
	 ...
	 <% if (List!=null){%>				
				...
				<tr class="tituloCabecera">
                    <td align="center">Nro de Hoja Ruta</td>
...
<!-- 				    <td align="center">Reporte</td> -->
				...
				<tr class="item" bgcolor="white" >
					...
					<td align="center"><%=List.getStatus().getDescripcion()%></td>
					<td align="center"><%=List.getTipo().getDescripcion()%></td>
...
<!-- 		                </td> -->
					...
					<%if (List.getStatus().getId()== Constantes.StatusPagado ){ %>
						<td class="grayplink" align="center"> 
		                   <img onclick="irAnulacion(2,'<%=List.getId()%>');" style="cursor:hand" src="<%=request.getContextPath()%>/images/ic3d_enviado.gif" width="14" height="13" title="Cambiar">
		                </td>
					<%}else{ %>
				...
				<%if (primera!=null){ %>
					 ...
					 <tr>
						<td align="center" class="grayp" style="padding-left: 20px; padding-bottom: 5px;">
							<div class="grayp"></div>
							<strong>No existen Hoja de Ruta pendientes por Cambiar Estatus</strong>
							<div class="grayp"></div>
						</td>
					</tr>
...
// 			if(document.getElementById('codigo1').value!=''){
				if(document.getElementById('codigo2').value!=''){
			        ...
			        document.forms[0].submit();
			          ...
			          alert("Debe especificar el codigo de la Hoja Ruta");
			     }
// 		   }else{
...
// 		   }
		...
		function ir1(acc,codig){
				    ...
				    document.getElementById('cod2').value=codig;
					document.getElementById('accionPago').value=acc;
			        document.forms[0].submit();
	...
	function irAnulacion(acc,codig){

		if(confirm('¿Esta seguro que desea realizar esta operación?')){
			document.getElementById('codigo2').value=codig;
			document.getElementById('accionPago').value=acc;
	        document.forms[0].submit();
        }
