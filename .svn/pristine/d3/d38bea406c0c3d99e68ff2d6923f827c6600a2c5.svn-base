 ...
 * @author lmontanez
 */
public class PersonalFacturaNoFillException extends Exception {
	/**
     * 
     */
	 ...
	 * 
	 */
	public PersonalFacturaNoFillException() {
		super();
		error = new Errores();
	}
	 ...
	 * @param arg0
	 */
	public PersonalFacturaNoFillException(String argDescripcion) {
	 ...
	 */
	public PersonalFacturaNoFillException(String argCodigo, String argMensaje) {
	 ...
	 * @param arg0
	 */
	public PersonalFacturaNoFillException(Throwable arg0) {
	...
	* @param arg0
	*/
   public PersonalFacturaNoFillException(Errores arg0) {
