...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Editar Siniestro" direct="true" />
	...
	<tiles:put name="cuerpo" direct="true">
		...
		<div class="parametro titulo "><c:out value="${siniestro.aniomesCodigo}-${siniestro.codigo}-${siniestro.subCodigo}" /></div>
		...
		<div class="parametro titulo "><c:out value="${siniestro.observacion}" /></div>
