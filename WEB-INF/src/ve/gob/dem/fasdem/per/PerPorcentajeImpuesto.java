...
import ve.gob.dem.fasdem.bean.PorcentajeImpuesto;
...
public class PerPorcentajeImpuesto extends PerGeneric {

	private static final String T_TABLA = "Proveedor.";
	private SqlMapClient cnx = null;

	public PerPorcentajeImpuesto() {
	...
	public PorcentajeImpuesto search(int id) throws PersonalNotFoundException, SQLException {
		PorcentajeImpuesto obj;
		obj = (PorcentajeImpuesto) cnx.queryForObject(T_TABLA.concat(KEY_SEARCH), id);
		if (obj != null)
			return obj;
		else
			throw new PersonalNotFoundException(" ");
