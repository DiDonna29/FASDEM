...
/**
 * Esta excepción se debe disparar cuando nos se consigue lo que
 * se esta buscando.
 * @author lmontanez
 */
public class PersonalNotSessionException extends Exception {
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public PersonalNotSessionException() {
		super();
		error = new Errores();
	}
	 ...
	 * @param arg0
	 */
	public PersonalNotSessionException(String argDescripcion) {
	 ...
	 */
	public PersonalNotSessionException(String argCodigo, String argMensaje) {
	 ...
	 * @param arg0
	 */
	public PersonalNotSessionException(Throwable arg0) {
	...
	* @param arg0
	*/
   public PersonalNotSessionException(Errores arg0) {
