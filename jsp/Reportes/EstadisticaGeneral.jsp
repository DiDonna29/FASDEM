...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Estadistica General"
		direct="true" />
	...
	<tiles:put name="cuerpo" direct="true">
		 ...
		 type="button" onclick="javascript:openWinScroll2('<%=request.getContextPath()%>/security/comunes/generareporte.do?id_reporte=9&fechaInicio='+this.document.forms[0].fechaInicio.value+'&fechaFin='+document.forms[0].fechaFin.value,'Usuarios',800,600);" /></div>
