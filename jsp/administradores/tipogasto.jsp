...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<input type="hidden" name="idtipoGasto" value="<c:out value="${idtipoGasto}" />"/>
					<table>
                
				<tr class="cgp" bgcolor="white">
					<td colspan="6"></td>
					<td align="right" colspan="2"><a class="nredp" href="<%=request.getContextPath()%>/security/administradores/AgregarTipoGasto.do">Agregar</a></td>
