...
<html:form action="${form_action}">
	...
	<div class="etiqueta padeo"><bean:message key="general.proveedor"
		bundle="etiquetas" /></div>
	<div class="parametro parampadeo"><html:hidden
		property="tipoProveedor" /> <html:text style="width: 200px;"
		styleClass="cgp" property="nombres"></html:text> </div>
