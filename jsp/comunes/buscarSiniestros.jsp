		...
		<c:if test="${titular!=null}">
			...
			<table class="tabla" cellpadding="2" cellspacing="1" border="0">
				...
				<tr class="tituloCabecera">
					<td align="left" bgcolor="white" colspan="8"><img width="160" height="120"
						src="<%=request.getContextPath()%>/security/foto/downloadFoto.do?cedula=<c:out value="${titular.beneficiario.cedula}" />&tipoPersona=<c:out value="${titular.beneficiario.tipoPersona}" />"></td>
				</tr>
				<tr class="tituloCabecera">
			...
			<table class="tabla" width="500" cellpadding="0" cellspacing="1" border="0">
				...
				<pg:pager maxPageItems="<%=20%>" maxIndexPages="10"
					url="buscarSiniestros.do" isOffset="false"
					...
					<c:forEach items="${siniestros}" var="sini">
						<pg:item>
							...
							maxFractionDigits="2" value="${sini.lsMontoAmparado}" /><input type="hidden" name="cedTitular"
									value="<c:out value="${certif}" />"/><input type="hidden" name="id"
