...
<tiles:insert page="/jsp/plantilla/plantilla.jsp">
	...
	<tiles:put name="titulopagina" content="Inicio / Liquidación / Liquidación de Medicinas"
		direct="true" />
...
<input
						...
						<input type="hidden" name="anioSiniestro" value="<c:out value="${Op.anioSiniestro}" />" />
			...
			<table class="tabla" width="600" cellpadding="2" cellspacing="1"
				...
				<tr class="tituloCabecera">
					...
					<td><bean:message key="general.usuarioCreador"
						bundle="etiquetas" /></td>
				...
				<tr class="item" bgcolor="white">
					...
					<td><c:out value="${Op.idUsuario}" /></td>	
