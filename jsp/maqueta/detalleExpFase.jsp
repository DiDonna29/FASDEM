	...
	<div class="line"></div>
		<table width="580" cellpadding="1" cellspacing="1"  >
			...
			<tr height="21">
       		...
       		<div class="sp5"></div>
			<tr height="21">
				<th  class="titulo delineadoBotton" ><bean:message key="general.nuevoRegimen" bundle="etiquetas" /></th>
				<td class="delineadoBotton">
				Sí </td>
			</tr>
 * 			 			<tr height="21">
				<th  class="titulo delineadoBotton" ><bean:message key="general.fase" bundle="etiquetas" /></th>
				<td class="delineadoBotton">
				<select>
					<option>Seleccione</option>
					<option>Por Adminsión</option>
					<option>En Citación</option>
					<option>En Contestación</option>
				</select> </td>
			</tr>
