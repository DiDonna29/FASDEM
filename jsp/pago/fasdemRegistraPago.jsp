...
%>
			...
			<div style="overflow: visible">
				...
				<input id="estatus" type="hidden" name="estatus" value="<%=Constantes.StatusONT%>">
				...
				<select name="tipoProveedor" class="cgp">
	 ...
	 <% if (List!=null && List.size()!=0){%>				
      ...
      %>  		
				...
				<tr class="item" bgcolor="white" >
					...
					<td><%=(list.getNro_orden()!=null)?list.getNro_orden():"--"%></td>
					<td><input type="text" name="fechaPago<%=list.getId() %>" value="<%=list.getFecha_pagado()==null?"":formato.format(list.getFecha_pagado())%>" onfocus="javascript:showCalendarSelected2(document.forms[0].fechaPago<%=list.getId()%>, document.forms[0].fechaPago<%=list.getId()%>, 'dd/mm/yyyy','es',1);blur();" class="cgp"></td>
