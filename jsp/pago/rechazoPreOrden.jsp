...
%>
	...
	<tiles:put name="titulopagina" content="Inicio / Pagos / Rechazo de PreOrdenes"
		direct="true" />
...
%>
	 ...
	 <% if (List!=null && List.size()!=0){%>				
				...
				<tr class="tituloCabecera">
                    <td align="center">Nro Pre Orden</td>
      ...
      %>  		
				...
				<tr class="item" bgcolor="white" >
					...
					<td align="center"><%=list.getCod_completo()%></td>
					...
					<%if (list.getEstatus().getId()== Constantes.StatusPagado ){ %>
						<td class="grayplink" align="center"> 
		                   <img onclick="irAnulacion(12,'<%=list.getCod_completo()%>');" style="cursor:hand" src="<%=request.getContextPath()%>/images/cross.png" width="14" height="13" title="Rechazar">
		                </td>
					<%}else{ %>
